...
```
java -Dspring.profiles.active=production -jar ./target/GestionBibliotecaMT-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/gestion-biblioteca-m-t
```
